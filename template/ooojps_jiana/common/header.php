		...
		<div id="hd">
			...
			<div>
                ...
                <div id="logo">
					...
					<h2><!--{if !isset($_G['setting']['navlogos'][$mnid])}--><em><a href="{if $_G['setting']['domain']['app']['default']}http://{$_G['setting']['domain']['app']['default']}/{else}./{/if}" title="$_G['setting']['bbname']">{$_G['style']['boardlogo']}</a><!--{else}-->$_G['setting']['navlogos'][$mnid]<!--{/if}--></em></h2>
				...
				<div id="nv">
                    ...
                    <script type="text/javascript" src="{$_G[style][styleimgdir]}/fixed.js"></script>
