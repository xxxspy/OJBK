	...
	<div id="ct" class="wp cl{if $_G['forum']['allowside']} ct2{/if}"{if $leftside} style="margin-left:{$_G['leftsidewidth_mwidth']}px"{/if}>
		...
		<div class="mn">
			...
			<div id="pgt" class="bm bw00 pgs cl">
				...
				<a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav"><em><img src="{IMGDIR}/pn_post.png" alt="{lang send_posts}" /></em></a>
				...
				<div id="threadlist" class="tl bm bmw"{if $_G['uid']} style="position: relative;"{/if}>
					...
					<div class="th">
						...
						<table cellspacing="0" cellpadding="0">
							...
							<tbody class="bw00_all" id="searchbody"{if !$searchbody} style="display: none"{/if}>
