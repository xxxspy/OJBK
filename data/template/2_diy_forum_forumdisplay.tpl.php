...
0
|| checktplrefresh('./template/ooojps_jiana/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1538148109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/ooojps_jiana', 'forum/forumdisplay')
|| checktplrefresh('./template/ooojps_jiana/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1538148109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/ooojps_jiana', 'forum/forumdisplay')
|| checktplrefresh('./template/ooojps_jiana/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1538148109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/ooojps_jiana', 'forum/forumdisplay')
|| checktplrefresh('./template/ooojps_jiana/forum/forumdisplay.htm', './template/ooojps_jiana/forum/forumdisplay_list.htm', 1538148109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/ooojps_jiana', 'forum/forumdisplay')
|| checktplrefresh('./template/ooojps_jiana/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1538148109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/ooojps_jiana', 'forum/forumdisplay')
|| checktplrefresh('./template/ooojps_jiana/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1538148109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/ooojps_jiana', 'forum/forumdisplay')
|| checktplrefresh('./template/ooojps_jiana/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1538148109, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/ooojps_jiana', 'forum/forumdisplay')
;?><?php include template('common/header'); ?><div id="wp" class="wp">
...
<th><strong class="xstt">公告: <?php if(empty($announcement['type'])) { ?><a href="forum.php?mod=announcement&amp;id=<?php echo $announcement['id'];?>#<?php echo $announcement['id'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } else { ?><a href="<?php echo $announcement['message'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } ?></strong></th>
...
<tbody id="separatorline" class="emptb"><tr><td class="icn"></td><?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?><td class="o"></td><?php } ?><th></th><?php if(CURMODULE == 'guide') { ?><td class="by"></td><?php } ?><td class="by"></td><td class="num"></td><td class="byy"></td></tr></tbody>
...
<th class="<?php echo $thread['folder'];?>">
                          ...
                          <div id="ue_st"><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>"><?php echo avatar($thread[authorid],small);?></a>
...
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>"<?php echo $thread['highlight'];?><?php if($thread['isgroup'] == 1 || $thread['forumstick']) { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> class="s xstt"><?php echo $thread['subject'];?></a>
...
<td class="num"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>" class="xi2"><?php echo $thread['allreplies'];?></a><span class="fenge">&frasl;</span><span><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></span></td>

<td class="byy">

<em style=" font-size:14px;"><span<?php if($thread['istoday']) { ?> class="xi1"<?php } ?>><?php echo $thread['dateline'];?></span></em>
...
<tbody class="bw00_all"><tr><th colspan="<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>6<?php } else { ?>5<?php } ?>"><p class="emp">本版块或指定的范围内尚无主题</p></th></tr></tbody>
...
<?php } } ?>
<div class="pgs cl" style="margin-top:10px;">
