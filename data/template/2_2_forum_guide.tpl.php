...
0
|| checktplrefresh('./template/ooojps_jiana/forum/guide.htm', './template/default/forum/guide_list_row.htm', 1538147779, '2', './data/template/2_2_forum_guide.tpl.php', './template/ooojps_jiana', 'forum/guide')
...
<a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav"><em><img src="<?php echo IMGDIR;?>/pn_post.png" alt="发新帖" /></em></a>
...
<tbody class="bw00_all" id="searchbody"<?php if(!$searchbody) { ?> style="display: none"<?php } ?>>
