...
0
|| checktplrefresh('./template/ooojps_jiana/common/header.htm', './template/default/common/header_common.htm', 1538147779, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/ooojps_jiana', 'common/header_forum_guide')
|| checktplrefresh('./template/ooojps_jiana/common/header.htm', './template/ooojps_jiana/common/pubsearchform.htm', 1538147779, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/ooojps_jiana', 'common/header_forum_guide')
|| checktplrefresh('./template/ooojps_jiana/common/header.htm', './template/default/common/header_qmenu.htm', 1538147779, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/ooojps_jiana', 'common/header_forum_guide')
;?>
...
<div class="hdc cl">
                ...
                <div id="logo"><?php $mnid = getcurrentnav();?><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><em><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></em></h2>
...
<ul><?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><li <?php if($mnid == $nav['navid']) { ?>class="a" <?php } ?><?php echo $nav['nav'];?>></li><?php } } ?>
                    ...
                    <script src="<?php echo $_G['style']['styleimgdir'];?>/fixed.js" type="text/javascript"></script>
