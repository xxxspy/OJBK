...
0
|| checktplrefresh('./template/ooojps_jiana/common/header.htm', './template/default/common/header_common.htm', 1538148096, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/ooojps_jiana', 'common/header_forum_viewthread')
|| checktplrefresh('./template/ooojps_jiana/common/header.htm', './template/ooojps_jiana/common/pubsearchform.htm', 1538148096, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/ooojps_jiana', 'common/header_forum_viewthread')
|| checktplrefresh('./template/ooojps_jiana/common/header.htm', './template/default/common/header_qmenu.htm', 1538148096, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/ooojps_jiana', 'common/header_forum_viewthread')
;?>
